...
class IncomingRequestController extends Controller
{
    public function store(
        ...
        $incomingRequest = $manager->receive([
            ...
            'attribution_first_touch' => $data['attribution']['first_touch'] ?? null,
            'attribution_last_touch' => $data['attribution']['last_touch'] ?? null,
            'attribution_method' => $data['attribution']['method'] ?? null,
            'attribution_confidence' => $data['attribution']['confidence'] ?? null,
