...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (blank($developerToken)) {
            throw new \LogicException('Le developer token Google Ads doit être présent avant sa restauration dans les organisations.');
        }
    ...
    {
        // The prior encrypted developer tokens cannot be reconstructed safely.
    }
};
