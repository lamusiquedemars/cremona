...
class DashboardPrioritiesTest extends TestCase
{
    ...
    public function test_the_dashboard_summarizes_todays_priorities_in_the_organization_timezone(): void
    {
        ...
        $this->actingAs($collaborator)
            ...
            ->assertSeeText('Voir les demandes')
            ->assertSeeText('Voir les correspondances')
            ->assertSeeText('Voir les tâches')
            ->assertSeeText('Voir les rendez-vous')
            ->assertSeeText('Voir les devis')
            ->assertSeeText('Voir les campagnes')
            ->assertDontSeeText('Cremona · 12:00 · Europe/Paris')
            ->assertDontSeeText('Action —')
            ->assertDontSeeText('Information —')
